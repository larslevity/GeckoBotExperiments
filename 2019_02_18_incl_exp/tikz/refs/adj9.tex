...
\draw[line width=\lw, fill=\col] (F1)++(405.000000 :.15) circle(.15);
\draw[line width=\lw] (F2)++(-44.000000 :.15) circle(.15);
\draw[line width=\lw, fill=\col] (F3)++(46.000000 :.15) circle(.15);
\draw[line width=\lw, fill=\col] (F4)++(224.000000 :.15) circle(.15);
