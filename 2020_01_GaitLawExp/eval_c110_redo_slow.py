# -*- coding: utf-8 -*-
"""
Created on Wed Jan 15 12:28:43 2020
...
for i in range(5):
    ...
    plt.figure('Bending angle-ref')
    plt.plot(x, ref_alp_ds, ':', color=color[i])
#    plt.plot(x, ref_ds*100, '--', color=color[i])

    plt.figure('Bending angle')
    plt.plot(x, alp_ds, color=color[i])
    plt.fill_between(x, alp_ds+sig, alp_ds-sig,
                     facecolor=color[i], alpha=0.5)

# add simulation
plt.plot(TIME, RESULT['alp'][2], 'orange', label='a2', alpha=opa)
plt.plot(TIME, REF['alp'][2], ':', color='orange', alpha=opa)
...
plt.plot(t1, RESULT['alp'][0][:switch_idx], '-', color='red', label='a0', alpha=opa)
plt.plot(t2, RESULT['alp'][0][switch_idx-1:], '-', color='red', alpha=opa)
plt.plot(TIME, REF['alp'][0], ':', color='red')

plt.plot(t1, RESULT['alp'][4][:switch_idx], '-', color='darkblue', label='a4', alpha=opa)
plt.plot(t2, RESULT['alp'][4][switch_idx-1:], '-', color='darkblue', alpha=opa)
plt.plot(TIME, REF['alp'][4], ':', color='darkblue', alpha=opa)

plt.plot(t1, RESULT['alp'][3][:switch_idx], '-', color='blue', label='a3', alpha=opa)
plt.plot(t2, RESULT['alp'][3][switch_idx-1:], '-', color='blue', alpha=opa)
plt.plot(TIME, REF['alp'][3], ':', color='blue', alpha=opa)


plt.plot(t1, RESULT['alp'][1][:switch_idx], '-', color='darkred', label='a1', alpha=opa)
plt.plot(t2, RESULT['alp'][1][switch_idx-1:], '-', color='darkred', alpha=opa)
plt.plot(TIME, REF['alp'][1], ':', color='darkred', alpha=opa)
...
#        plt.plot(t, phi_1[i], color=get_feet_color()[i])
    ...
    plt.plot(x[:switch_exp], y[:switch_exp], ls_[0],
             color=get_feet_color()[i])
    plt.plot(x[switch_exp-1:], y[switch_exp-1:], ls_[1],
             color=get_feet_color()[i])
    plt.fill_between(x, y+sig, y-sig,
...
# add sim
plt.plot(TIME, np.array(RESULT['eps'][0])-90, 'green', label='eps', alpha=opa)
plt.plot(TIME, REF['eps'][0], ':', color='green', label='eps', alpha=opa)

plt.plot(t1, RESULT['phi'][1][:switch_idx], '-', color='darkred', label='phi1', alpha=opa)
plt.plot(t2, RESULT['phi'][1][switch_idx-1:], '--', color='darkred', alpha=opa)
plt.plot(TIME, REF['phi'][1], ':', color='darkred', alpha=opa)

plt.plot(t1, RESULT['phi'][0][:switch_idx], '--', color='red', label='phi0', alpha=opa)
plt.plot(t2, RESULT['phi'][0][switch_idx-1:], '-', color='red', alpha=opa)
plt.plot(TIME, REF['phi'][0], ':', color='red', alpha=opa)

plt.plot(t1, RESULT['phi'][3][:switch_idx], '--', color='darkblue', label='phi3', alpha=opa)
plt.plot(t2, RESULT['phi'][3][switch_idx-1:], '-', color='darkblue', alpha=opa)
plt.plot(TIME, REF['phi'][3], ':', color='darkblue', alpha=opa)

plt.plot(t1, RESULT['phi'][2][:switch_idx], '-', color='blue', label='phi2', alpha=opa)
plt.plot(t2, RESULT['phi'][2][switch_idx-1:], '--', color='blue', alpha=opa)
plt.plot(TIME, REF['phi'][2], ':', color='blue', alpha=opa)

plt.ylabel('phi / epsilon [rad]')
